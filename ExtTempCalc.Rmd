...
### Conductive heat loss through top insulation #

The conductive loss through the t is

$$
Q_{surf.top} = \frac{2 \pi k ( (r_i)^2 (\Delta T) )}
{dx_{ends}}
$$
Which can be rewritten as 

$$
Q_{surf.top} = \frac{2 \pi k  (\frac{diam- 2 dx_{ends}}{2})^2 (T_{water} - T_{surf}) }
{dx_{ends}}
$$
and then simplified as 

$$
Q_{surf.top} = \frac{ \pi k  ({diam- 2 dx_{ends}})^2 (T_{water} - T_{surf}) }
{2dx_{ends}}
$$

```{r}
Qsurf.top = ( pi * k * (diam - 2 * dx_ends)^2  * (Twater - Tsurf) )/ 
        ( 2*dx_ends) 
