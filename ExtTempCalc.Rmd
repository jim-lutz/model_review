...
The Rayleigh number is calculated as ${Gr}{Pr}$. In these conditions the Rayleigh number is `r sprintf("%5.4e",Gr()*Pr())`


## Heat Loss from Side Surface to Ambient #

For this Rayleigh number and Prandtl number the Nusselt Number is calculated as @technical_committee_13_heat_transfer_and_fluid_flow_chapter_2017 
$$
Nu = \left\{{0.825 + \frac{0.387Ra^{\frac{1}{6}}}
                { \left[ 1 + \left( \frac{0.437}{Pr} \right) ^ \frac{9}{16} \right] ^\frac{8}{27}}} \right\}^2
$$
